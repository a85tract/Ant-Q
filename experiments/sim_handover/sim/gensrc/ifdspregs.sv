...
modport regs(input resetacc,stb_resetacc,amp,stb_amp,bramsel,stb_bramsel,coef00,stb_coef00,coef01,stb_coef01,coef02,stb_coef02,coef03,stb_coef03,coef10,stb_coef10,coef11,stb_coef11,coef12,stb_coef12,coef13,stb_coef13,coef20,stb_coef20,coef21,stb_coef21,coef22,stb_coef22,coef23,stb_coef23,coef30,stb_coef30,coef31,stb_coef31,coef32,stb_coef32,coef33,stb_coef33,dacsel,stb_dacsel,dspreset,stb_dspreset,nshot,stb_nshot,qdrvfreqsel,stb_qdrvfreqsel,rdlofreqsel,stb_rdlofreqsel,rdrvfreqsel,stb_rdrvfreqsel,reset_bram_read,stb_reset_bram_read,start,stb_start,test,stb_test,acqbufreset,stb_acqbufreset,dacmonreset,stb_dacmonreset,decimator,stb_decimator,acqchansel0,stb_acqchansel0,acqchansel1,stb_acqchansel1,dacmonchansel0,stb_dacmonchansel0,dacmonchansel1,stb_dacmonchansel1,dacmonchansel2,stb_dacmonchansel2,dacmonchansel3,stb_dacmonchansel3,delayaftertrig,stb_delayaftertrig,mixbb1sel,stb_mixbb1sel,mixbb2sel,stb_mixbb2sel,shift,stb_shift,copper_tx_en_mst,stb_copper_tx_en_mst,copper_tx_rst_mst,stb_copper_tx_rst_mst,copper_tx_en_slv,stb_copper_tx_en_slv,copper_tx_rst_slv,stb_copper_tx_rst_slv,copper_corr64_h,stb_copper_corr64_h,copper_corr64_l,stb_copper_corr64_l,copper_clkcnt_sw,stb_copper_clkcnt_sw,copper_clkcnt_trig_h,stb_copper_clkcnt_trig_h,copper_clkcnt_trig_l,stb_copper_clkcnt_trig_l,use_sync,stb_use_sync
,output addr_accbuf_mon0,addr_accbuf_mon1,addr_accbuf_mon2,addr_accbuf_mon3,busy,lastshotdone,shotcnt,test1,procdone,cnt00,cnt01,cnt02,cnt03,cnt10,cnt11,cnt12,cnt13,cnt20,cnt21,cnt22,cnt23,cnt30,cnt31,cnt32,cnt33,copper_tx_clkcnt_mst_h,copper_tx_clkcnt_mst_l,copper_rx_clkcnt_mst_h,copper_rx_clkcnt_mst_l,copper_tx_clkcnt_slv_h,copper_tx_clkcnt_slv_l,copper_rx_clkcnt_slv_h,copper_rx_clkcnt_slv_l,copper_dspclkcnt_h,copper_dspclkcnt_l
);
...
wire [32-1:0] cnt32;
wire [32-1:0] cnt33;
wire [1-1:0] copper_tx_en_mst;reg [1-1:0] reg_copper_tx_en_mst=1;reg stb_copper_tx_en_mst;assign copper_tx_en_mst=reg_copper_tx_en_mst;
wire [1-1:0] copper_tx_rst_mst;reg [1-1:0] reg_copper_tx_rst_mst=0;reg stb_copper_tx_rst_mst;assign copper_tx_rst_mst=reg_copper_tx_rst_mst;
wire [32-1:0] copper_tx_clkcnt_mst_h;
wire [32-1:0] copper_tx_clkcnt_mst_l;
wire [32-1:0] copper_rx_clkcnt_mst_h;
wire [32-1:0] copper_rx_clkcnt_mst_l;
wire [1-1:0] copper_tx_en_slv;reg [1-1:0] reg_copper_tx_en_slv=1;reg stb_copper_tx_en_slv;assign copper_tx_en_slv=reg_copper_tx_en_slv;
wire [1-1:0] copper_tx_rst_slv;reg [1-1:0] reg_copper_tx_rst_slv=0;reg stb_copper_tx_rst_slv;assign copper_tx_rst_slv=reg_copper_tx_rst_slv;
wire [32-1:0] copper_tx_clkcnt_slv_h;
wire [32-1:0] copper_tx_clkcnt_slv_l;
wire [32-1:0] copper_rx_clkcnt_slv_h;
wire [32-1:0] copper_rx_clkcnt_slv_l;
wire [32-1:0] copper_corr64_h;reg [32-1:0] reg_copper_corr64_h=0;reg stb_copper_corr64_h;assign copper_corr64_h=reg_copper_corr64_h;
wire [32-1:0] copper_corr64_l;reg [32-1:0] reg_copper_corr64_l=0;reg stb_copper_corr64_l;assign copper_corr64_l=reg_copper_corr64_l;
wire [1-1:0] copper_clkcnt_sw;reg [1-1:0] reg_copper_clkcnt_sw=1;reg stb_copper_clkcnt_sw;assign copper_clkcnt_sw=reg_copper_clkcnt_sw;
wire [32-1:0] copper_clkcnt_trig_h;reg [32-1:0] reg_copper_clkcnt_trig_h=0;reg stb_copper_clkcnt_trig_h;assign copper_clkcnt_trig_h=reg_copper_clkcnt_trig_h;
wire [32-1:0] copper_clkcnt_trig_l;reg [32-1:0] reg_copper_clkcnt_trig_l=536870912;reg stb_copper_clkcnt_trig_l;assign copper_clkcnt_trig_l=reg_copper_clkcnt_trig_l;
wire [32-1:0] copper_dspclkcnt_h;
wire [32-1:0] copper_dspclkcnt_l;
wire [1-1:0] use_sync;reg [1-1:0] reg_use_sync=0;reg stb_use_sync;assign use_sync=reg_use_sync;
...
stb_copper_tx_en_mst<=(lb.waddr==67)&lb.wren;if (stb_copper_tx_en_mst) reg_copper_tx_en_mst<=wdata[1-1:0];
stb_copper_tx_rst_mst<=(lb.waddr==68)&lb.wren;if (stb_copper_tx_rst_mst) reg_copper_tx_rst_mst<=wdata[1-1:0];
stb_copper_tx_en_slv<=(lb.waddr==73)&lb.wren;if (stb_copper_tx_en_slv) reg_copper_tx_en_slv<=wdata[1-1:0];
stb_copper_tx_rst_slv<=(lb.waddr==74)&lb.wren;if (stb_copper_tx_rst_slv) reg_copper_tx_rst_slv<=wdata[1-1:0];
stb_copper_corr64_h<=(lb.waddr==79)&lb.wren;if (stb_copper_corr64_h) reg_copper_corr64_h<=wdata[32-1:0];
stb_copper_corr64_l<=(lb.waddr==80)&lb.wren;if (stb_copper_corr64_l) reg_copper_corr64_l<=wdata[32-1:0];
stb_copper_clkcnt_sw<=(lb.waddr==81)&lb.wren;if (stb_copper_clkcnt_sw) reg_copper_clkcnt_sw<=wdata[1-1:0];
stb_copper_clkcnt_trig_h<=(lb.waddr==82)&lb.wren;if (stb_copper_clkcnt_trig_h) reg_copper_clkcnt_trig_h<=wdata[32-1:0];
stb_copper_clkcnt_trig_l<=(lb.waddr==83)&lb.wren;if (stb_copper_clkcnt_trig_l) reg_copper_clkcnt_trig_l<=wdata[32-1:0];
stb_use_sync<=(lb.waddr==86)&lb.wren;if (stb_use_sync) reg_use_sync<=wdata[1-1:0];
end
always @(posedge lb.clk) begin
...
65: rdata <= cnt32;
66: rdata <= cnt33;
67: rdata <= copper_tx_en_mst;
68: rdata <= copper_tx_rst_mst;
69: rdata <= copper_tx_clkcnt_mst_h;
70: rdata <= copper_tx_clkcnt_mst_l;
71: rdata <= copper_rx_clkcnt_mst_h;
72: rdata <= copper_rx_clkcnt_mst_l;
73: rdata <= copper_tx_en_slv;
74: rdata <= copper_tx_rst_slv;
75: rdata <= copper_tx_clkcnt_slv_h;
76: rdata <= copper_tx_clkcnt_slv_l;
77: rdata <= copper_rx_clkcnt_slv_h;
78: rdata <= copper_rx_clkcnt_slv_l;
79: rdata <= copper_corr64_h;
80: rdata <= copper_corr64_l;
81: rdata <= copper_clkcnt_sw;
82: rdata <= copper_clkcnt_trig_h;
83: rdata <= copper_clkcnt_trig_l;
84: rdata <= copper_dspclkcnt_h;
85: rdata <= copper_dspclkcnt_l;
86: rdata <= use_sync;
