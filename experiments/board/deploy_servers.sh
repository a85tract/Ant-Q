...
SRC=${SOFTWARE_C3:-$HERE/../../software}/scripts          # dma_server.c / batch_server.c: the software submodule (or SOFTWARE_C3)
...
scp $SRC/dma_server.c $SRC/batch_server.c $HERE/std_server.c computerC:/home/xilinx/software/scripts/
