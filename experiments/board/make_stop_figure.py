...
LABEL = {'GHZ-3': 'GHZ-3', 'GHZ-6': 'GHZ-6', 'GHZ-8': 'GHZ-8', 'VQE BeH2 14Q': 'VQE\nBeH$_2$', 'QML Image Class 14Q': 'QML Image\nClass',
...
ax.legend(loc='upper center', ncol=3, frameon=False, fontsize=8, bbox_to_anchor=(0.5, 1.04))
