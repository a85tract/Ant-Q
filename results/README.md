...
| `rq3_v2/` | Simulator study: per-run outputs (`rq3_<backend>.csv`, one row per circuit and seed) and checkpoint traces (`*_checkpoints.csv`) on six fake backends, and the circuit parameters (`angles_v2.json`) | none (simulation) |
